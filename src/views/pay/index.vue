  ...
  <div class="pay">
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-way">
        ...
        <div class="pay-cell">
          <span
            ><van-icon name="balance-o" />余额支付（可用 ¥ {{personal.balance}} 元）</span
          >
          <!-- <span>请先选择配送地址</span> -->
    ...
    <div class="footer-fixed">
      ...
      <div class="tipsbtn" @click="subOrder">提交订单</div>
    </div>
  </div>
</template>
...
import { setDefaultadd } from '@/api/address'
...
export default {
  ...
  methods: {
    ...
    async setAdd () {
      await setDefaultadd(this.address)
    }
